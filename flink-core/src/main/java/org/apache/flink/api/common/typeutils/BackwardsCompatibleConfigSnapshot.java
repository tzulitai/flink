...
/**
 * A utility {@link TypeSerializerConfigSnapshot} that is used for backwards compatibility purposes, in
 * the case that an actual restored config snapshot is tagged as a {@link UnrestorableSerializerConfigSnapshot}.
 *
 ...
 *
 * @see UnrestorableSerializerConfigSnapshot
