...
public class KryoSerializerCompatibilityTest {
	...
	public void testMigrationStrategyForRemovedAvroDependency() throws Exception {
		...
		TypeSerializerSchemaCompatibility<TestClass, ?> compatResult = kryoSerializerForA.ensureCompatibility(kryoSerializerConfigSnapshot);
	...
	public void testMigrationStrategyWithDifferentKryoType() throws Exception {
		...
		TypeSerializerSchemaCompatibility<TestClassB, ?> compatResult = kryoSerializerForB.ensureCompatibility(kryoSerializerConfigSnapshot);
	...
	public void testMigrationStrategyForDifferentRegistrationOrder() throws Exception {
		...
		TypeSerializerSchemaCompatibility<TestClass, ?> compatResult = kryoSerializer.ensureCompatibility(kryoSerializerConfigSnapshot);
		assertTrue(compatResult.isCompatibleAsIs());
