...
public class TestableKinesisDataFetcher extends KinesisDataFetcher<String> {
	...
	public TestableKinesisDataFetcher(List<String> fakeStreams,
									  ...
									  Map<KinesisStreamShard, String> restoredStateUnderTest,
									  AtomicReference<Throwable> thrownErrorUnderTest,
									  LinkedBlockingQueue<KinesisStreamShardState> pendingShardsQueueUnderTest,
	...
	@Override
	protected void emitRecordAndUpdateState(String record, int shardStateIndex, String lastSequenceNumber) {
