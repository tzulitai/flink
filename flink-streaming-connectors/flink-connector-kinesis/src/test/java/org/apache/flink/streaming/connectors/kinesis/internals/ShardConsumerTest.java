...
public class ShardConsumerTest {
	...
	public void testCorrectNumOfCollectedRecordsAndUpdatedState() {
		...
		subscribedShardsStateUnderTest.add(new KinesisStreamShardState(fakeToBeConsumedShard, "fakeStartingState"));
		new KinesisStreamShardState(fakeToBeConsumedShard, "fakeStartingState").getShard();
		...
		new ShardConsumer<>(
			fetcher,
			0,
			subscribedShardsStateUnderTest.get(0).getShard(),
