...
public class KinesisStreamShard implements Serializable {
	...
	public String getEndingSequenceNumber() {
		SequenceNumberRange sequenceNumberRange = shard.getSequenceNumberRange();
		return (sequenceNumberRange == null) ? null : sequenceNumberRange.getEndingSequenceNumber();
	}

	public String getStartingHashKey() {
		HashKeyRange hashKeyRange = shard.getHashKeyRange();
		return (hashKeyRange == null) ? null : hashKeyRange.getStartingHashKey();
	}

	public String getEndingHashKey() {
		HashKeyRange hashKeyRange = shard.getHashKeyRange();
		return (hashKeyRange == null) ? null : hashKeyRange.getEndingHashKey();
	}
