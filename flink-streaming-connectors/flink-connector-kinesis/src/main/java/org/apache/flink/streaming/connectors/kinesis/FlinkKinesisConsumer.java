...
public class FlinkKinesisConsumer<T> extends RichParallelSourceFunction<T>
	...
	private transient HashMap<KinesisStreamShard, String> lastStateSnapshot;
	...
	public void run(SourceContext<T> sourceContext) throws Exception {
		...
		fetcher = new KinesisDataFetcher<>(
			streams, sourceContext, getRuntimeContext(), configProps, lastStateSnapshot, deserializer);
