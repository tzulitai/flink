...
public class FlinkKafkaConsumer08<T> extends FlinkKafkaConsumerBase<T> {
	...
	public FlinkKafkaConsumer08(List<String> topics, KeyedDeserializationSchema<T> deserializer, Properties props) {
		super(topics, null, deserializer, getLong(props, KEY_PARTITION_DISCOVERY_INTERVAL_MILLIS, DEFAULT_PARTITION_DISCOVERY_INTERVAL_MILLIS));
		...
		this.autoCommitInterval = getLong(props, "auto.commit.interval.ms", 60000);
	}
