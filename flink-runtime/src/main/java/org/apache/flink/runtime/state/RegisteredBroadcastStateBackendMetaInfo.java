...
public class RegisteredBroadcastStateBackendMetaInfo<K, V> extends RegisteredStateMetaInfoBase {
	...
	public RegisteredBroadcastStateBackendMetaInfo(
		...
		this(
			name,
			assignmentMode,
			StateSerializerProvider.from(keySerializer),
			StateSerializerProvider.from(valueSerializer));
	}
	...
	public TypeSerializer<K> getKeySerializer() {
		return keySerializerProvider.getStateSerializer();
	}

	@Nonnull
	public TypeSerializer<V> getValueSerializer() {
		return valueSerializerProvider.getStateSerializer();
	}
