...
public class StreamTwoInputProcessor<IN1, IN2> {
	...
	/**
	 * Valves that control how watermarks and stream statuses from the 2 inputs are forwarded. The valves should
	 * be created in {@link StreamTwoInputProcessor#setup(TwoInputStreamOperator)}, before any inputs are processed.
	 */
	...
	public void setup(final TwoInputStreamOperator<IN1, IN2, ?> streamOperator) {
