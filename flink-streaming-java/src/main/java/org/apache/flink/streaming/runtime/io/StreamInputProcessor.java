...
public class StreamInputProcessor<IN> {
	...
	/**
	 * Valve that controls how watermarks and stream statuses are forwarded. The valve should
	 * be created in {@link StreamInputProcessor#setup(OneInputStreamOperator)}, before any inputs are processed.
	 */
	...
	/** This method needs to be called before any {@link StreamInputProcessor#processInput()} calls */
	public void setup(final OneInputStreamOperator<IN, ?> streamOperator) {
