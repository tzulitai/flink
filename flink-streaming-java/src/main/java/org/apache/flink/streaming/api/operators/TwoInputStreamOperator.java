...
public interface TwoInputStreamOperator<IN1, IN2, OUT> extends StreamOperator<OUT> {
	...
	/**
	 * Processes a {@link WatermarkStatus} that arrived on the first input of this two-input operator.
	 * This method is guaranteed to not be called concurrently with other methods of the operator.
	 *
	 * @see org.apache.flink.streaming.api.watermark.WatermarkStatus
	 */
	void processWatermarkStatus1(WatermarkStatus watermarkStatus) throws Exception;

	/**
	 * Processes a {@link WatermarkStatus} that arrived on the second input of this two-input operator.
	 * This method is guaranteed to not be called concurrently with other methods of the operator.
	 *
	 * @see org.apache.flink.streaming.api.watermark.WatermarkStatus
	 */
