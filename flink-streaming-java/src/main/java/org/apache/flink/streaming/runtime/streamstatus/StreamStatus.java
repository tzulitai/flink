...
/**
 * A Stream Status element informs receiving operators whether or not they should continue to expect records and
 * watermarks from the sending input stream. There are 2 kinds of status, namely {@link StreamStatus#IDLE} and
 ...
 * are considered either idle or active is explained as following:
 *
 * <ul>
 ...
 *         This guarantee should be enforced on sources in
 ...
 *         further downstream through their outgoing streams once they toggle between being idle or active.</li>
 * </ul>
 *
 * <p>
 ...
 *         regardless of whether there are input data at the operator anywhere in the middle of topologies, all
 ...
 *         that are temporarily idle, or has resumed to be active but its watermark is behind the overall watermark
 *         progress of the operator, should not be accounted for when deciding whether or not to advance the operator's
 *         watermark.</li>
 * </ul>
 *
 * <p>
