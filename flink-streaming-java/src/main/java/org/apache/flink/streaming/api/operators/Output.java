...
public interface Output<T> extends Collector<T> {
	...
	/**
	 * Emits a {@link StreamStatus} from an operator. This trigger is broadcast to all downstream
	 * operators.
	 *
	 * <p>This can be either a {@link StreamStatus#IDLE} or a {@link StreamStatus#ACTIVE}.
	 * An idle status specifies that the operator will temporarily stop emitting records and
	 * watermarks. Emitting an active status afterwards indicates that it will resume to do so.
	 */
